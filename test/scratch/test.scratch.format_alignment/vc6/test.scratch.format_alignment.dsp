# Microsoft Developer Studio Project File - Name="test.scratch.format_alignment" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=test.scratch.format_alignment - Win32 Debug pseudoUNIX
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.format_alignment.mak".
!MESSAGE
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE
!MESSAGE NMAKE /f "test.scratch.format_alignment.mak" CFG="test.scratch.format_alignment - Win32 Debug pseudoUNIX"
!MESSAGE
!MESSAGE Possible choices for configuration are:
!MESSAGE
!MESSAGE "test.scratch.format_alignment - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.format_alignment - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE "test.scratch.format_alignment - Win32 Debug pseudoUNIX" (based on "Win32 (x86) Application")
!MESSAGE
...
!IF  "$(CFG)" == "test.scratch.format_alignment - Win32 Release"
...
!ELSEIF  "$(CFG)" == "test.scratch.format_alignment - Win32 Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT)/include" /I "$(FASTFORMAT_ROOT)/include" /D "WIN32" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib advapi32.lib /nologo /version:1.0 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.format_alignment.debug.exe" /pdbtype:sept /libpath:"$(FASTFORMAT_ROOT)/lib"
# SUBTRACT LINK32 /pdb:none

!ELSEIF  "$(CFG)" == "test.scratch.format_alignment - Win32 Debug pseudoUNIX"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "$(STLSOFT)/include" /I "$(FASTFORMAT_ROOT)/include" /I "$(UNIXEM)/include" /D "UNIX" /D "_DEBUG" /D "STRICT" /D "_CONSOLE" /D "_STLSOFT_FORCE_ANY_COMPILER" /FR /YX /FD /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0xc09 /d "_DEBUG"
# ADD RSC /l 0xc09 /d "_DEBUG"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib advapi32.lib /nologo /version:1.0 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.format_alignment.debug.exe" /pdbtype:sept /libpath:"$(FASTFORMAT_ROOT)/lib"
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 kernel32.lib advapi32.lib /nologo /version:1.0 /subsystem:console /map /debug /machine:I386 /out:"Debug/test.scratch.format_alignment.debug.exe" /pdbtype:sept /libpath:"$(FASTFORMAT_ROOT)/lib" /libpath:"$(UNIXEM)/lib"
# SUBTRACT LINK32 /pdb:none
...
# Name "test.scratch.format_alignment - Win32 Release"
# Name "test.scratch.format_alignment - Win32 Debug"
# Name "test.scratch.format_alignment - Win32 Debug pseudoUNIX"
...
SOURCE=..\test.scratch.format_alignment.cpp
# End Source File
# End Group
